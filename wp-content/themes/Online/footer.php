<footer class="footer">
	<div class="wrapper">
		<div class="footer__info">
			<img class="footer__logo" src="<?php echo URI . IMG . 'logo-alt.svg' ?>" alt="">
			<div class="footer__menu">
				<p>Mo – So <b>8:00 – 23:00</b></p>
				<a href="mailto:info@onlineklausuren.de">info@onlineklausuren.de</a>
				<a href="tel:+493022389844"><i class="fa-solid fa-phone-flip"></i>+49 (30) 223-898-44</a>
				<a href="https://wa.me/493022389844"><i class="fa-brands fa-whatsapp"></i>WhatsApp</a>
				<a href="#fb" class="btn__hover"><i class="fa-solid fa-pen"></i>UNVERBINDLICH ANFRAGEN</a>
			</div>
			<div class="footer__last">
				<p>© 2012 - 2023 OnlineKlausuren Alle Rechte vorbehalten.</p>
